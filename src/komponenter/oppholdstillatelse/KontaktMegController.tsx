    ...
    return (
      <>
        {oppgaveStatus === "NOT_STARTED" ? (
          <KontaktMegForm opprettKontaktmegOppgave={opprettKontaktmegOppgave} />
        ) : null}
        {oppgaveStatus === "PENDING" ? (
          <div className="blokk-m center">
            <NavFrontendSpinner type="XXL" />
          </div>
        ) : null}
        {oppgaveStatus === "OK" ? <OppgaveSuccess kontaktinfo={kontaktinfo} /> : null}
        {oppgaveStatus === "ERROR" ? (
          oppgaveStatusCode === 403 ? (
            <OppgaveErrorTooSoon kontaktinfo={kontaktinfo} />
          ) : (
            <OppgaveError />
          )
        ) : null}
