...
export type Props = OwnProps & StateProps & RouteComponentProps<MatchProps>;
...
class Skjema extends React.Component<Props, OwnState> {
  ...
  gaaTilStartHvisForegaendeSporsmalIkkeBesvart = (): void => {
    ...
    /*
        ...
        */
    if (horerTilSykefravaerLop && !erSporsmalBesvart(this.props.svarState, SporsmalId.fremtidigSituasjon)) {
      this.props.history.push(START_PATH);
      return;
    }
    ...
    return (
      <ResponsivSide>
        ...
        <Animasjon flag={this.props.match.params.id}>
          <LenkeNeste onClick={this.handleNesteBtnClick} href={nesteHref} erAktiv={kanGaaTilNesteTmp} />
...
export default connect(mapStateToProps)(injectIntl<Props>(Skjema));
