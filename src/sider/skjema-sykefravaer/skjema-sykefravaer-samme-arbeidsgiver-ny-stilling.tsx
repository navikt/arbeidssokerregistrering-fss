...
class SkjemaSykefravaerSammeArbeidsgiverNyStilling extends React.Component<Props> {
  render() {
    ...
    const sporsmal = sammeArbeidsgiverNyStillingSporsmaleneConfig(fellesProps, regType).map(
      (spmElement) => spmElement.element
    );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(injectIntl<Props>(SkjemaSykefravaerSammeArbeidsgiverNyStilling));
