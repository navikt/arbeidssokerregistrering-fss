...
class Fullfor extends React.PureComponent<Props, EgenState> {
  ...
  getSvarMappetForBackend() {
    ...
    return mapAvgitteSvarForBackend(
      state.svar,
      selectSisteStilling(state),
      intl,
      ...
      >
        <section className={`fullfor ${erIE() && "erIE"}`}>
          ...
          <div className="fullfor-sjekkliste">
            <img src={utropstegnSvg} alt="Fullfør sjekkliste" className="fullfor-sjekkliste__illustrasjon" />
            ...
            >
              <ul className="fullfor-info-liste">
                <li className="fullfor-info-liste__element">
                  <img src={okonomiSvg} alt="Økonomi" className="illustrasjon" />
                  <Element className="tittel">Økonomi</Element>
                  <Normaltekst>
                    <FormattedMessage id="fullfor-les-mer-okonomi" />
                  </Normaltekst>
                </li>
                <li className="fullfor-info-liste__element">
                  <img src={epostSvg} alt="Meldekort" className="illustrasjon" />
                  <Element className="tittel">Meldekort</Element>
                  <Normaltekst>
                    <FormattedMessage id="fullfor-les-mer-meldekort" />
                  </Normaltekst>
                </li>
                <li className="fullfor-info-liste__element">
                  <img src={kalenderSvg} alt="Aktivitetsplan" className="illustrasjon" />
                ...
                <li className="fullfor-info-liste__element">
                  <img src={filnySvg} alt="CV" className="illustrasjon" />
                  <Element className="tittel">CV</Element>
                  <Normaltekst>
                    <FormattedMessage id="fullfor-les-mer-CV" />
                  </Normaltekst>
                </li>
              </ul>
            </Ekspanderbartpanel>
