  ...
  if (errorData && errorData.data) {
    switch (errorData.data.type) {
      case FullforErrorTypes.BRUKER_MANGLER_ARBEIDSTILLATELSE: {
        return <FeilmeldingBrukersStatusUgyldig feilType={FullforErrorTypes.BRUKER_MANGLER_ARBEIDSTILLATELSE} />;
      }
      case FullforErrorTypes.BRUKER_ER_DOD_UTVANDRET_ELLER_FORSVUNNET: {
        return (
          <FeilmeldingBrukersStatusUgyldig feilType={FullforErrorTypes.BRUKER_ER_DOD_UTVANDRET_ELLER_FORSVUNNET} />
        );
      }
